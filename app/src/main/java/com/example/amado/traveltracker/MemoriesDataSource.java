...
public class MemoriesDataSource {
    ...
    private String[] allColumns = {
            DbHelper.COLUMN_ID, mDbHelper.COLUMN_CITY, mDbHelper.COLUMN_COUNTRY,
            DbHelper.COLUMN_LATUTIDE, DbHelper.COLUMN_LONGITUDE,DbHelper.COLUMN_NOTES
    };
    ...
    public void createMemory(Memory memory){
        ...
        values.put(DbHelper.COLUMN_LATUTIDE, memory.latitude);
    ...
    public void updateMemory(Memory memory){
        ...
        mDbHelper.getWritableDatabase().update(mDbHelper.MEMORIES_TABLE, values,
                mDbHelper.COLUMN_ID + "=?", whereArgs);
    }
    ...
    public void deleteMemory(Memory memory){
        String[] whereArgs = {String.valueOf(memory.id)};
        mDbHelper.getWritableDatabase().delete(mDbHelper.MEMORIES_TABLE,
                mDbHelper.COLUMN_ID+"=?", whereArgs);
    }
